    ...
    return (
        <>
            <div className="uk-card uk-margin-small-bottom" uk-grid>
                ...
                <img src={blog.frontMatter.thumbnail} alt="" className="recent_thumbnail" />
                    <div className="uk-padding-small uk-margin-small-left uk-padding-remove-vertical uk-padding-remove-right">
                    <h5 className="uk-margin-remove uk-text-bold">{blog.frontMatter.title}</h5>
                    <div className="uk-margin-small-top uk-text-uppercase">
                        <div className="uk-text">{new Date(blog.frontMatter.date).toLocaleDateString('en-US', {day: 'numeric',month: 'short',year: 'numeric'})}</div>
