            ...
            <div className="uk-card uk-margin-small-bottom" uk-grid>
                ...
                <img src={blog.thumbnail} alt="" className={styles["recent_thumbnail"]} />
                    ...
                    <div className="uk-margin-small-top uk-text-uppercase">
                        ...
                        <Link href={`/blogs/${blog.slug}`}><button className={`uk-text-bold uk-button uk-button-link uk-margin-small-bottom ${styles['color_blue']}`}>Read Article <span uk-icon="arrow-right"></span></button></Link>
                    </div>
                    </div>
                </div>
            </div>
