...
export const Template: ComponentStory<typeof AnnualFish> = (args) => <AnnualFish {...args} />;
...
Template.args={
  frontMatter: {
    ...
    author: 'Akhil Nair',
    date: '01/01/2023',
    authorAvatar: 'https://ui-avatars.com/api/?background=F8C02F&color=4E2E07&name=Akhil Nair&size=128&font-size=0.4'
  },
