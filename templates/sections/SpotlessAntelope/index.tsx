        ...
        <div className=' uk-container' style={{ position: 'relative' }}>
          ...
          >
            <div style={{ position: 'relative', zIndex: 10 }}>
              <div
                className={`uk-h1 uk-text-bolder ${styles['color_midnight-blue']}`}
              >
                {title}
              </div>
            ...
            <div
              className={`uk-position-bottom-right uk-visible@m ${styles['height_350']} `}
            >
              <Image src={`${image.url}`} fill={true} alt={'image'}></Image>
            </div>
            <div className={`${styles['height_350']} uk-hidden@m`}></div>
            <div
              className={`uk-position-bottom uk-hidden@m ${styles['height_350']}`}
            >
              <Image src={`${image.url}`} fill={true} alt={'image'}></Image>
            </div>
          </div>
