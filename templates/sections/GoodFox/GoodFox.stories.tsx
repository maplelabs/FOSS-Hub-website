...
export const Template: ComponentStory<typeof GoodFox> = (args) => (
  <GoodFox {...args} />
);
  ...
  listItems: [
    {
      ...
      description:
        'This is a portal which hosts the code for MapleLab`s Opensource website. You can contribute to this repo and add templates.',
      link: '',
    ...
    },
    {
      ...
      description:
        'This is a repo for scaling manager. You can contribute to this repo and add templates.',
      link: '',
